...
from constants import MODEL_DATA_DIR
...
class GerkeBaseModel(BaseModel):
    def __init__(self, type):
        super(GerkeBaseModel, self).__init__('gerke_base', type)
