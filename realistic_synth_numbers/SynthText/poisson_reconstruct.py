...
if __name__=='__main__':
    ...
    im_src = cv2.imread('/home/nina/Documents/hockey_tracking/number_recognition/number_recognition/data/number1.png').astype('float32')

    im_dst = cv2.imread('/home/nina/Documents/hockey_tracking/number_recognition/number_recognition/data/players/player6.jpg').astype('float32')
