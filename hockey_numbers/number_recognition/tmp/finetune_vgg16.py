...
csv_logger = CSVLogger('./model/vgg16_log.csv')
checkpoint = ModelCheckpoint('./model/checkpoints/vgg16/weights.{epoch:02d}-{val_loss:.2f}.hdf5', monitor='val_loss', verbose=0, save_best_only=False, save_weights_only=False, mode='auto')
...
predictions = Dense(nb_outputs, activation='softmax')(x)
