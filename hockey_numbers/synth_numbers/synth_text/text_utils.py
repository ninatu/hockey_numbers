...
class RenderFont(object):
    ...
    def __init__(self, data_dir='data'):
        ...
        self.min_nchar = 0
        self.min_font_h = 15#30 #px : 0.6*12 ~ 7px <= actual minimum height
        self.max_font_h = 20#40 #px
        self.p_flat = 0.10
        ...
        self.text_source = TextSource(min_nchar=self.min_nchar,
                                      fn=osp.join(data_dir,'text/text.txt'))
